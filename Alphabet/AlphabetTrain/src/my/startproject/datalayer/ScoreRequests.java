	...
	public void getLastUserScores(IScoreReceived listener)
	{
		...
		query.findInBackground(new FindCallback<ParseObject>() {
		    public void done(List<ParseObject> scoreList, ParseException e) {
		        if (e == null) {
		        	UserModelByScores user = new UserModelByScores(ParseUser.getCurrentUser().getUsername());
		           ...
		           if(scoreList.isEmpty())
		           {
		        	   ...
		        	   uscoreModel = new ScoreModel(user, currentScores, currentLevel);
		           }
		    ...
		    public void done(List<ParseObject> scoreList, ParseException e) {
		        if (e == null) {
		           ...
		           if(scoreList.isEmpty())
		           {
		        	   ...
		        	   uscoreModel = new ScoreModel(user, newScores, currentLevel);
		           }
