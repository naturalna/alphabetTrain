...
public class AsyncProcessTask extends AsyncTask<String, String, Boolean> {
	...
	public AsyncProcessTask(HardFragment activity) {
	...
	/** application context. */
	private final HardFragment activity;
