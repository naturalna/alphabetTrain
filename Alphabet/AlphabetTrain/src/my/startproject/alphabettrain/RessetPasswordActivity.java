...
public class RessetPasswordActivity extends Activity implements IPasswordReset{
	...
	public void resetPassword(View v)
	{
		...
		UserResetRequest request = new UserResetRequest(RessetPasswordActivity.this, user);
		request.Reset();
		turnOnProgressDialog("Reset", "Please wait while we reset your password");
	}
	...
	public void resetSucceed() {
		...
		Intent homeIntent = new Intent(RessetPasswordActivity.this, SigninActivity.class);
	...
	public void resetFaild() {
		turnOffProgressDialog();
		Toast.makeText(RessetPasswordActivity.this,"Password was not reset. Place try again.",
